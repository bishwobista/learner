<x-app-layout>
    <x-slot name="header">
        ...
        <form action="{{route('cards.import')}}" method="POST" enctype="multipart/form-data" class="max-w-sm mx-auto">
            ...
            <div class="mb-6">
                <label for="csv-file" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Import CSV</label>
                <input type="file" name="file" id="file"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
        
            <button type="submit"
                class="text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
        </form>
        <div class="mb-6">
